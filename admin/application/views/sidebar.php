            ...
            <div class="d-flex">
                ...
                <!-- <div class="dropdown d-inline-block d-lg-none ms-2">
                    <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-search-dropdown"
                      data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-magnify"></i>
                    </button>
        ...
        <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="dashboard.php" class="waves-effect"><i class="bx bx-home-circle"></i>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                          ...
                          <span key="t-ecommerce">Registrations</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                          <li><a href="expense.php" key="t-products">Expense</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                          <li><a href="users.php" key="t-login">users</a></li>
